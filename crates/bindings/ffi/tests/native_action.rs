//! The C ABI a host calls across, exercised against a real native fixture.
//!
//! What crosses here is a wire request and a wire response; the calendar source
//! itself is the provider adapter's to test.
