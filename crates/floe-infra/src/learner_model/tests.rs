...
use floe_agent::{
    Cancellation, KNOWLEDGE_VERSION, KnowledgeActor, KnowledgeCandidate, LearningObservationKind,
...
use floe_agent::{
    ...
    LearningEvidenceRef, ModelResponse, PersonalMemoryKind,
};
...
async fn structured_learner_uses_a_local_restricted_request() {
    ...
    assert_eq!(requests[0].prompt.role, floe_agent::PromptRole::Learner);
