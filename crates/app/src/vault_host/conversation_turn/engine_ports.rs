use floe_agent_contract::{
    ...
    ModelConversation, ModelConversationEntry, ModelPort, ModelRequest, ModelResponse, ModelStep,
    TaskReceipt,
};
use floe_conversation::GovernedSessionStore;
use floe_conversation::turn::UsageLedger;
use floe_conversation::{
    AgentMessage as LegacyMessage, CapabilityDescriptor, ModelRequest as LegacyModelRequest,
    ModelResponse as LegacyModelResponse, ModelRunner as LegacyModelRunner,
    ModelStep as LegacyModelStep,
};
...
mod tests {
    ...
    use super::*;
    use floe_agent_contract::{
        DataClass, DependencyCoverage, InvocationKey, ModelPlacement, ToolCall, ToolDescriptor,
