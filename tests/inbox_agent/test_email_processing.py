...
from inbox_agent.email_processor import parse_email_actions, process_new_email
...
@patch('inbox_agent.email_processor.parse_email_actions', return_value=[{"action": "PROPOSE_SCHEDULE", "details": {"text": "hi"}}])
