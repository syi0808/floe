...
Implementation ownership belongs to [current architecture](../architecture/README.md). Active refactoring belongs to [Stage 2](../refactoring/stage-2.md). Historical planning bundles and slice plans live in Git history.
