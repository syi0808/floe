...
| 04 | [Binding, authority, interaction and product cutover](04-binding-and-product-cutover.md) | Complete | Binding/schema foundation `6bb857e6`; admitted selection and Vault fence `b668eed5`; Context candidate/exact acquisition `64d66a37`, `1e9bee39`, `2ad8ace4`; durable interactions and opaque settings `1723ffca`, `fabe8518`; trusted exact-consumer policy `1071734e`; race/recovery regressions `8f86f31e`, `9127fb1a`, `9e2d38b7`; current architecture `fcbf73a9`. Targeted owner/App/Flutter suites, workspace check, qualified serial full workspace test, architecture checker, FFI build, Flutter analyze/full test/macOS build and diff check passed. |
...
The [03-B/F runner-binding closure](03-bf-runner-binding-closure.md) and checkpoint 04 are complete. The existing proposal-card golden exception remains byte-identical to the checkpoint-04 starting commit. Checkpoint 05 is Not started.
