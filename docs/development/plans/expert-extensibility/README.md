...
| 01 | [Current contract regressions](01-contract-regressions.md) | Complete | Exact target and multi-grant fixture `109fe443e76a01fcabafbe22e4e97f3d12ffd172`; Rust-generated result/client contract `7911651b119b4eae36eaa04a306ba7fc61448481`; Manager policy and reviewed fingerprint `7249130843bbdd377004ccaf4e3da01e3a2478b8`; authority regressions `e8e60c2ad3fa71c51bc7fc6e5b9a843c83bf39cf`; current architecture `d2818e076fdc80b70014ac8c889b6a7e55759ed3`; Flutter golden assertion disabled by request and full suite passed `38105fb3520c6157129216b7fe15464bde4a2a22`. |
| 02 | [Prompt, result and settlement contracts](02-result-and-prompt-contracts.md) | Complete | Canonical report/Task/A2A result, delegated prompt/inference identity, package artifacts, exact Actions proposal settlement, generic Flutter projection and Rust-generated fixture: `ea968e76aa7e88c00e2fe9f300a36ebe7a5ed922`. Targeted Rust packages, workspace check/test, architecture checker, FFI build, Flutter analyze/test/macOS build and diff check passed. |
| 03 | [Generic Registry and runtime registration](03-registry-and-runtime.md); completed [03-B/F runner-binding closure](03-bf-runner-binding-closure.md) | Complete | Prior implementation evidence retained: Atomic Directory and pinned Task `0ef358da`; exact durable admission and assignment-local settlement `04bcdf5e`; Registry/Flutter DTO `e606f91b`; generic manifest, install, and bundle seams `184cb4ee`, `4acf3c0e`, `b7186a19`, `4086d091`, `7d3545ad`, `8859f0a5`; declared-source host, trusted consumer policy, and Context current selection `22312760`, `d5a6d5f9`; current architecture `a53b608e`. Owner tests, workspace check, serial full workspace test (`CARGO_INCREMENTAL=0 RUST_TEST_THREADS=1`), architecture checker, FFI build, Flutter analyze/test/macOS build, and diff check passed at that baseline. Parallel Vault/App runs encountered deadline-sensitive test timeouts; the same complete suites passed serially. BF-3 client target cleanup `bd197be1`; bound product runner, real App acceptance and runtime architecture `dd4f8df8`; [BF-0 through BF-4 execution evidence](03-bf-runner-binding-closure.md) `e970c6a4`. The new targeted and full qualified serial gates passed; no default-parallel run is claimed. Persistent source binding remains unimplemented until 04. |
| 04 | [Binding, authority, interaction and product cutover](04-binding-and-product-cutover.md); [residual closure](04-residual-closure.md) | Reopened: residual closure not started | Prior 04 evidence retained: binding/schema `6bb857e6`; admitted selection/Vault fence `b668eed5`; Context candidate/exact acquisition `64d66a37`, `1e9bee39`, `2ad8ace4`; durable interactions/settings `1723ffca`, `fabe8518`; exact-consumer policy `1071734e`; races/recovery `8f86f31e`, `9127fb1a`, `9e2d38b7`; architecture `fcbf73a9`. Closure plan: `0a56b537063cc0157d2dd8cca6f9daf99aa6a7ee`; implementation not started. |
...
The [03-B/F runner-binding closure](03-bf-runner-binding-closure.md) is complete. Checkpoint 04 implementation evidence is retained, but review reopened the focused [04 residual closure](04-residual-closure.md); do not start 05 until that closure is complete. The existing proposal-card golden exception remains byte-identical to the checkpoint-04 starting commit. Checkpoint 05 is Not started.
