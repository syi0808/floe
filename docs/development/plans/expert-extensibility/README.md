...
The [03-B/F runner-binding closure](03-bf-runner-binding-closure.md) is complete. Checkpoint 04 remains Not started and requires its own execution authorization; the existing proposal-card golden exception stays unchanged.
