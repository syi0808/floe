...
| 03 | [Generic Registry and runtime registration](03-registry-and-runtime.md) | In progress | Atomic Directory owner-set publication and pinned Task endpoint groundwork: `0ef358da8efbe31646ca3aa025c777c601755f8f`; Registry overview/Flutter synthetic grant-count removal: `e606f91bf6f39ea55f9efdf4aa0bec2b8be60804`. Generic Registry, exact admission identity, declared-source host and assignment-local settlement remain incomplete. |
