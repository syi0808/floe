...
| 03 | [Generic Registry and runtime registration](03-registry-and-runtime.md) | In progress | Atomic Directory publication and pinned endpoint `0ef358da8efbe31646ca3aa025c777c601755f8f`; Registry overview/Flutter synthetic grant-count removal `e606f91bf6f39ea55f9efdf4aa0bec2b8be60804`; exact durable Task admission and assignment-local settlement `04bcdf5e0c52ac992bdc016869b8ec7f43dd3e15`; shipped manifest/runner registration and dependency edge `184cb4ee`. Generic Registry/install and declared-source host remain incomplete. |
