...
const observeScope = "slack.selected_conversation.read"
...
func ConnectionSnapshot(view common.WorkContextView) (common.Snapshot, error) {
	...
	return common.Snapshot{
		...
		Connection: common.Connection{SchemaVersion: 1, ConnectorID: "slack.conversations", State: "ready", GrantedScopes: []string{observeScope}, ObservedAtUnixMS: view.ObservedAtUnixMS, LastSuccessAtUnixMS: &lastSuccess},
